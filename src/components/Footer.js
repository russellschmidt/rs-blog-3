...
const IconSquare = props => (
  <p className={iconP}>
    <a className={iconA} href={props.url} target="_blank">
      <img className={`${iconImg} ${iconSquare} ${props.iconSpecific}`} src={props.imgUrl} alt={props.altText} />
    </a>
  </p>
);
...
const IconCircle = props => (
  <p className={iconP}>
    <a className={iconA} href={props.url} target="_blank">
      <img className={`${iconImg} ${iconCircle} ${props.iconSpecific}`} src={props.imgUrl} alt={props.altText} />
    </a>
  </p>
);
...
export default () => (
  <footer className={componentGrid}>
    ...
    />
    <IconSquare
      iconSpecific={iconStackOverflow}
