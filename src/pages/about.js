...
class BioArticle extends Component {
  render () {
    return (        
      <article>
        <h3>Biography</h3>
...
class EdArticle extends Component {
  render () {
    return (
      <article>
        <h3>Education</h3>
...
class OpenSourceContributionsList extends Component {
  render () {
    return (
      <ul>
...
class OpenSourceProjectsList extends Component {
  render () {
    return (
      <ul>
